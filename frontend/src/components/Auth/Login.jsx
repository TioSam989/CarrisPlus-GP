...
>>>>>>> 8092f96e54106ec7f6175e5dec9d6f7bb2768957

            <div className="auth-right">
                <div className="auth-card">
                    <h2 className="card-title">Bem Vindo(a)</h2>
                    <p className="card-subtitle">
                        Faça login na sua aplicação e <span className="text-yellow">gerencie</span> o seu passe <span className="text-blue">rapidamente</span>.
                    </p>
